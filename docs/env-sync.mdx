...
For YAML files, comments, key ordering, and formatting of selected sections are preserved. JSON files use [gjson](https://github.com/tidwall/gjson) paths for extraction.
