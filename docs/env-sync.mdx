...
**Version resolution**: `--version` flag takes priority. If omitted and the upstream profile specifies a version, that version is used. Otherwise, HEAD is resolved.
