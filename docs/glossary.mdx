...
**Profile** - A named, labeled env entry in an upstream `b.yaml` that describes a logical grouping of files (e.g., `#base`, `#monitoring`). Discovered via `b env profiles` and installed via `b env add`.
