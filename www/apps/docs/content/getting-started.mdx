...
b install jq@jq-1.6 kubectl@v1.28.0
...
```bash
# Add tools to b.yaml
b install --add jq@jq-1.6 kubectl@v1.28.0
...
The `b.yaml` file defines your project's tool requirements:
