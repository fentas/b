...
**b.yaml** - The configuration file that defines binary dependencies for a project. Contains version specifications and metadata.
...
**Configuration Discovery** - The process by which **b** automatically locates and loads the nearest `b.yaml` file in the directory hierarchy.
...
**Project-Based Configuration** - Using **b.yaml** files to define tool requirements specific to individual projects.
