...
**Problem**: `b.yaml configuration file not found`
...
**Problem**: YAML parsing errors in **b.yaml**
...
# Clean up old versions (if implemented)
b clean

# Manually remove old binaries
